    ...
    <div className="viewPane">
      ...
      <div className="viewHeader">
        ...
        <div className="headerRight">
          ...
          <input
            className="selectPill yearInput"
            type="number" min={2000} max={curY} value={year}
            onChange={e => {
              const v = parseInt(e.target.value, 10);
              if (v < 2000 || v > curY) return;
              // Clamp month if jumping into current year and selected month is future
